...
def get_global_top_tickers():
    ...
    tickers = [
        ...
        "5831.T", "6501.T", "6752.T", "6758.T", "6988.T", "7186.T", "7201.T", "7202.T", "7203.T", "7205.T", "7211.T",
        ...
        "ANTO.L", "ANZ.AX", "AON", "APA", "APA.AX", "APD", "APH", "APT.AX", "ARW", "ASIANPAINT.NS", "ASML",
        "ASML.AS", "ASRNL.AS", "ASX.AX", "ATD.TO", "ATO.PA", "AV.L", "AVB", "AVGO", "AVY", "AWK",
        "AXISBANK.NS", "AXP", "AZN", "AZN.L", "BA", "BA.L", "BABA", "BAC", "BAFN.SW", "BAJFINANCE.NS", "BARC.L",
        "BAS.DE", "BATS.L", "BAX", "BAYN.DE", "BBDC4.SA", "BBY", "BCE", "BDX", "BEI.DE", "BEN",
        "BHARTIARTL.NS", "BHP.AX", "BILL", "BK", "BKNG", "BLK", "BMO", "BMW.DE", "BMY", "BNP.PA", "BNS",
        "BNS.TO", "BP", "BP.L", "BRK-A", "BRK-B", "BT-A.L", "BXB.AX", "C", "CA.PA", "CABK.MC", "CAP.PA",
        "CARR", "CAT", "CBA.AX", "CCH.L", "CDNS", "CE", "CFR.SW", "CHTR", "CI", "CL", "CLNX.MC", "CM.TO",
        "CMCSA", "CME", "CMG", "CMI", "CNP", "CNQ", "CNR.TO", "COF", "COIN", "COL.AX", "CON.DE", "COO",
        "COP", "COST", "CP.TO", "CPG.L", "CPRT", "CPT", "CRM", "CRWD", "CS.PA", "CSCO", "CSGN.SW", "CSL.AX",
        "CSU.TO", "CSX", "CTAS", "CTSH", "CVS", "CVX", "D", "DAI.DE", "DAL", "DASH", "DB1.DE", "DBK.DE", "DD",
        "DDOG", "DE", "DFS", "DG", "DG.PA", "DGE.L", "DGX", "DHER.DE", "DHI", "DHL.DE", "DHR", "DIS", "DLR",
        "DLTR", "DOV", "DOW", "DPW.DE", "DSM.AS", "DTE.DE", "DTG.DE", "DUK", "DVN", "DXCM", "EA", "EBAY",
        "EIX", "EL", "EMN", "EN.PA", "ENB", "ENB.TO", "ENEL.MI", "ENG.MC", "ENGI.PA", "ENI.MI", "ENPH",
        "ENR.DE", "EOAN.DE", "EOG", "EQNR.OL", "EQR", "ERF.PA", "ES", "ESS", "ETN", "ETSY", "EW", "EXC",
        "EXPD", "EXPE", "F", "FAST", "FDX", "FE", "FER.MC", "FFIV", "FIS", "FISV", "FITB", "FLG.MC", "FLTR.L",
        "FME.DE", "FMG.AX", "FRE.DE", "FRES.L", "FSLR", "GD", "GE", "GGB", "GGBR4.SA", "GIB-A.TO", "GILD",
        "GIS", "GIVN.SW", "GLE.PA", "GLW", "GM", "GMG.AX", "GOOG", "GOOGL", "GPN", "GRF.MC", "GRMN", "GS",
        ...
        "IDR.MC", "IDXX", "IEX", "IFX.DE", "IHG.L", "III.L", "ILMN", "IMCD.AS", "IMO.TO", "IMP.L", "INF.L",
        "INFY.NS", "INGA.AS", "INTC", "INTU", "IP", "IPG", "IQV", "IR", "IRM", "ISP.MI", "ISRG", "ITRK.L",
        "ITUB", "ITUB4.SA", "ITW", "ITX.MC", "IVZ", "JCI", "JD.L", "JNJ", "JPM", "K", "KER.PA", "KEY", "KHC",
        "KIM", "KMB", "KMI", "KO", "KOTAKBANK.NS", "KPN.AS", "KR", "L", "L.TO", "LAND.L", "LEG", "LGEN.L",
        "LH", "LHX", "LIN", "LIN.DE", "LLC.AX", "LLOY.L", "LLY", "LMT", "LNT", "LOGN.SW", "LOW", "LR.PA",
        "LT.NS", "LUV", "LVMH.PA", "LYB", "LYV", "M&M.NS", "MA", "MAP.MC", "MAR", "MARUTI.NS", "MAS", "MB.MI",
        "MBG.DE", "MC.PA", "MCD", "MCHP", "MCK", "MCO", "MDB", "MDLZ", "MDT", "MEL.MC", "META", "MFC", "MG.TO",
        "ML.PA", "MMC", "MMM", "MNG.L", "MNST", "MO", "MOS", "MPC", "MQG.AX", "MRK", "MRK.DE", "MRL.MC",
        "MRO", "MRO.L", "MS", "MSCI", "MSFT", "MSI", "MTB", "MTD", "MTX.DE", "MU", "MUV2.DE", "NAB.AX",
        "NCLH", "NCM.AX", "NDAQ", "NEE", "NEM", "NESN.SW", "NET", "NFLX", "NG.L", "NI", "NKE", "NN.AS", "NOC",
        "NOVN.SW", "NOVO-B.CO", "NOW", "NRG", "NSC", "NST.AX", "NTAP", "NTGY.MC", "NTR.TO", "NTRS", "NVDA",
        "NVR", "NWG.L", "NWL", "NWSA", "O", "OCADO.L", "OKE", "OKTA", "OR.PA", "ORA.PA", "ORCL", "OXY",
        "P911.DE", "PAH3.DE", "PANW", "PART.SW", "PATH", "PAYC", "PAYX", "PBR", "PCAR", "PDD", "PEG", "PEP",
        "PETR4.SA", "PFE", "PFG", "PG", "PGR", "PH", "PHIA.AS", "PHM", "PHNX.L", "PINS", "PKG", "PLD",
        "PLTR", "PM", "PNC", "PNR", "PNW", "POOL", "PPG", "PPL", "PRU", "PRU.L", "PRX.AS", "PSA", "PSN.L",
        "PSON.L", "PSX", "PUB.PA", "PUM.DE", "PVH", "PWR", "PXD", "PYPL", "QAN.AX", "QBE.AX", "QCOM",
        "QIA.DE", "QRVO", "RACE.MI", "RAND.AS", "RBLX", "RCL", "REG", "REGN", "RELIANCE.NS", "REN.AS",
        "REP.MC", "RF", "RHI", "RHM.DE", "RI.PA", "RIO.AX", "RIO.L", "RL", "RMD", "RMS.PA", "RNO.PA",
        "ROG.SW", "ROK", "ROKU", "ROL", "ROP", "ROST", "RR.L", "RSG", "RTO.L", "RTX", "RWE.DE", "RY", "RY.TO",
        "SAF.PA", "SAN.MC", "SAN.PA", "SAP", "SAP.DE", "SBAC", "SBIN.NS", "SBRY.L", "SBUX", "SCCO", "SCG.AX",
        "SCHW", "SCMN.SW", "SEDG", "SEE", "SGE.L", "SGO.PA", "SGP.AX", "SGSN.SW", "SHEL", "SHEL.L",
        "SHELL.AS", "SHL.DE", "SHOP.TO", "SHW", "SIE.DE", "SJM", "SLB", "SLF.TO", "SLHN.SW", "SMIN.L", "SMT.L",
        "SN.L", "SNA", "SNOW", "SO", "SOFI", "SPG", "SPGI", "SPOT", "SQ", "SRE", "SREN.SW", "SRT3.DE",
        "SSE.L", "STAN.L", "STE", "STLA", "STM.MI", "STO.AX", "STT", "STX", "STZ", "SU", "SU.PA", "SU.TO",
        "SUN.AX", "SUNPHARMA.NS", "SWK", "SWKS", "SY1.DE", "SYK", "T", "T.TO", "TAP", "TATASTEEL.NS",
        "TCL.AX", "TCS.NS", "TD", "TD.TO", "TDG", "TE.PA", "TEF.MC", "TEL", "TEN.MI", "TFC", "TFX", "TGT",
        "TITAN.NS", "TJX", "TLS.AX", "TMO", "TMUS", "TRMB", "TRP", "TRP.TO", "TRV", "TSCO", "TSCO.L",
        "TSLA", "TSN", "TT", "TTD", "TTE", "TTE.PA", "TWLO", "TXN", "TXT", "U", "UAL", "UBSG.SW", "UCG.MI",
        "UDR", "UGI", "UHR.SW", "UL", "ULVR.L", "UMG.AS", "UMG.PA", "UMPQ", "UNA.AS", "UNH", "UNP", "UPS",
        "UPST", "URI", "USB", "V", "VALE", "VALE3.SA", "VFC", "VICI", "VIE.PA", "VIV.PA", "VLO", "VMC",
        "VNA.DE", "VNO", "VOD.L", "VOLV-B.ST", "VOW3.DE", "VRSK", "VRSN", "VRTX", "VTR", "VZ", "WBA",
        "WBC.AX", "WBD", "WCN.TO", "WDAY", "WDC", "WDS.AX", "WEC", "WEGE3.SA", "WELL", "WES.AX", "WFC",
        "WHR", "WIPRO.NS", "WKL.AS", "WM", "WMB", "WMT", "WOW.AX", "WPM", "WRB", "WRK", "WST", "WTB.L",
        "WY", "WYNN", "XEL", "XOM", "XRX", "XYL", "YUM", "ZAL.DE", "ZBH", "ZBRA", "ZION", "ZM", "ZS", "ZTS",
        "ZURN.SW"
    ]
